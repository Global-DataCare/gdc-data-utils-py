...
VALUE_SET = {'canonicalReference': 'http://hl7.org/fhir/ValueSet/formatcodes',
 'canonicalUrl': 'http://hl7.org/fhir/ValueSet/formatcodes',
 'resolved': True,
 'version': '4.0.1',
 'name': 'DocumentReferenceFormatCodeSet',
 'title': 'DocumentReference Format Code Set',
 'status': 'active',
 'description': 'The value set is defined to be the set of format codes defined by the IHE '
                ...
                'it should provide sufficient information to allow any potential document consumer '
                'to know    if it will be able to process the document. The code shall be '
                'sufficiently specific to    ensure processing/display by identifying a document '
                'encoding, structure and template. The actual list of codes here is incomplete',
 ...
 'usages': [{'resourceType': 'DocumentReference',
             ...
             'elementId': 'DocumentReference.content.format',
